...
public interface QuestionMapper {
    ...
    List<Question> findQuestionByPage(@Param("start") Integer start, @Param("end")Integer end,@Param("search")String search);

//    @Select("select count(1) from question")
    Integer findCounts(@Param("search") String search);
